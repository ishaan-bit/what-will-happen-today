...
export const love = [
  {
    id: 'L001',
    teaser: 'You might hear from someone you weren\'t expecting today.',
    full: 'A name you\'ve been thinking about — or trying not to — may actually surface. When it does, you\'ll probably act more neutral than you feel. That gap between your reaction and the performance is worth noticing.',
    ...
    shareSnippet: 'You might hear from someone you weren\'t expecting today. Watch the gap between how you react and how you feel.',
  },
  {
    id: 'L002',
  ...
  },
  {
    ...
    full: 'The urge will be real. The excuses will also be real, but mostly borrowed — wrong timing, too busy, they probably don\'t want to hear from you right now. Most of that will be protective, not accurate.',
  ...
  },
  {
    ...
    full: 'A conversation, a moment, something you said or did will be revisited. The other person\'s interpretation of it may surprise you. What seemed clear to you wasn\'t read that way.',
    action: 'Be open to the possibility that your version and theirs are both partially right.',
    timing: 'Watch how this plays out after noon.',
    shareSnippet: 'Something from last week will come back up today. The other person\'s version may surprise you.',
  },
  {
    id: 'L013',
    teaser: 'You\'ll feel pulled in two directions about someone today.',
    full: 'Someone will trigger both closeness and retreat at the same time — something about them will appeal and resist in the same moment. You\'ll probably oscillate without landing somewhere.',
  ...
  },
  {
    ...
    full: 'The timing will feel pointed — it\'ll land either when you finally had a moment of peace or when you needed something to shift a difficult stretch. The message itself may be completely ordinary.',
  ...
  },
  {
    ...
    full: 'Something has shifted without being named. You\'ll be more careful with your words, more aware of your reactions, less willing to be open. You may not know exactly why — but the shift is real.',
  ...
  },
  {
    ...
    full: 'Something in the rhythm of this relationship will be different from how it usually runs. A changed tone, a new kind of directness, or a subtle withdrawal. Small shifts compound — notice this one.',
  ...
  },
  {
    ...
    full: 'You mentally filed something away as resolved. But the other person hasn\'t fully closed it out — or the circumstances have changed enough that it needs revisiting. You may find this out the hard way today.',
  ...
  },
  {
    ...
    full: 'There\'ll be a specific kind of quiet that lands around midday or evening. Not loneliness exactly — more like an awareness of distance from the people who matter. The desire will be there. The words for it won\'t.',
  ...
  {
    id: 'L024',
    teaser: 'A person from your past may surface today in some form.',
    ...
    timing: 'By tonight, this will be clearer.',
    shareSnippet: 'A person from your past may surface today. It will carry more weight than it should.',
  },
  {
    id: 'L025',
  ...
  },
  {
    ...
    action: 'Don\'t walk it back. The honesty was probably right.',
    timing: 'You will feel this most before you sleep.',
    shareSnippet: 'You\'ll be more honest than you planned to be today. Don\'t walk it back.',
  },
  {
    id: 'L030',
    teaser: 'Something small today will feel like a signal. You\'ll probably be right.',
    full: 'An instinct about someone or something between two people will surface briefly and clearly. The instinct will feel like it might be too small to count. In this area, small usually means something.',
    action: 'Track it. Don\'t act immediately but don\'t dismiss it.',
    timing: 'This shows up when you are least distracted.',
    shareSnippet: 'Something small today will feel like a signal about someone. You\'ll probably be right.',
  },
  {
    id: 'L031',
  ...
  },
  {
    ...
    full: 'Something you haven\'t heard from — a connection that was on standby, a silence that felt like it might be permanent — will break. However small the signal, it means the line is still open.',
  ...
  },
  {
    ...
    full: 'Not a reveal of bad character — just a dimension that wasn\'t visible before. It might be vulnerability, sharpness, warmth, or something completely unexpected. How you respond to it matters.',
  ...
  },
  {
    ...
    full: 'There\'ll be a visible suppression — you maintaining composure while something underneath moves differently. Someone who knows you will catch it. You may or may not talk about it.',
  ...
  },
  {
    ...
    full: 'A reach-out, a request, a moment where someone who usually manages fine will show up needing more than usual. The ask may not come in obvious language — but it will be there.',
  ...
  },
  {
    ...
    full: 'They\'ll do something ordinary — check in, remember something, take a small extra step. They won\'t realize how much it registers. This kind of quiet care tends to land disproportionately.',
  ...
  },
  {
    ...
    full: 'A line you hadn\'t thought to draw will be approached. It may be a request, a comment, a behavior — something that clarifies where your actual boundary is by almost crossing it.',
  ...
  {
    id: 'L047',
    teaser: 'A conversation that has been delayed too long might finally happen today.',
    ...
    timing: 'Notice this in the first conversation that matters today.',
    shareSnippet: 'A conversation that has been delayed too long might finally have room today.',
  },
  {
    id: 'L048',
