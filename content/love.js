...
export const love = [
 ...
 {
 id: 'L053',
 teaser: 'Someone will be more careful with their words around you today than usual.',
 full: 'You\'ll feel it before you can name it: a slightly chosen sentence, a pause that wasn\'t there before. They\'re editing in real time. The reason is not nothing.',
 action: 'Don\'t fill the pause for them. Let them choose.',
 timing: 'This shows up when you are least distracted.',
 shareSnippet: 'Someone will be more careful with their words around you today. The reason is not nothing.',
 },
 {
 id: 'L054',
 teaser: 'You will misread a short message today and respond to the version in your head.',
 full: 'A line will arrive without tone. Your brain will assign one. The conversation that follows will be with that imagined tone, not the actual person. By evening you may realise you were arguing with no one.',
 action: 'Before you reply, ask what the most generous reading of those words could be.',
 timing: 'Pay attention to this before the day gets complicated.',
 shareSnippet: 'You will misread a short message today and respond to the version in your head.',
 },
 {
 id: 'L055',
 teaser: 'Someone will give you a soft compliment today and you\'ll deflect it on instinct.',
 full: 'It will be small, almost casual. You\'ll bat it away before you\'ve even heard it. The reflex protects you from being seen, but it also tells the other person not to do that again.',
 action: 'Just say thank you. Even if it feels like too much.',
 timing: 'Notice this in the first conversation that matters today.',
 shareSnippet: 'Someone will give you a soft compliment today and you\'ll deflect it on instinct. Just say thank you.',
 },
 {
 id: 'L056',
 teaser: 'A pattern in how you behave around one specific person will become visible today.',
 full: 'You\'ll catch yourself doing the thing you always do: shrinking, performing, over-explaining, going quiet. Once today, you\'ll see it from the outside. That\'s the opening. The pattern can\'t change while it\'s invisible.',
 action: 'Name the pattern to yourself the moment you notice it. Naming is half the work.',
 timing: 'You will feel this most before you sleep.',
 shareSnippet: 'A pattern in how you behave around one person will become visible today. Naming is half the work.',
 },
 {
 id: 'L057',
 teaser: 'You will feel something close to jealousy today, about something smaller than it should be.',
 full: 'A photo, a mention, a casual tag. The reaction will be disproportionate to the input. The disproportion is the data. It\'s not about the photo.',
 action: 'Trace the feeling back to what it actually wants. Don\'t stop at the surface trigger.',
 timing: 'This surfaces by evening.',
 shareSnippet: 'You will feel jealousy today, about something smaller than it should be. The disproportion is the data.',
 },
 {
 id: 'L058',
 teaser: 'A conversation you have been rehearsing in your head will not happen today, again.',
 full: 'You\'ve been writing both sides of a script that the other person has no idea exists. You\'ll add another draft today. The script keeps getting better while the conversation keeps not happening.',
 action: 'Send the version that\'s 60 percent ready. The 100 percent version never gets sent.',
 timing: 'This shows up when you are least distracted.',
 shareSnippet: 'A conversation you have been rehearsing will not happen today, again. The 100 percent version never gets sent.',
 },
 {
 id: 'L059',
 teaser: 'You will be invited into something casual today and read more into it than the sender meant.',
 full: 'A plan, a question, a stray hi at an odd hour. Your brain will start building the larger meaning. Most likely they were just bored or polite. Some of the time they were not. The skill is staying open to either.',
 action: 'Reply to what was actually said. Not to the meaning you assigned.',
 timing: 'Watch how this plays out after noon.',
 shareSnippet: 'You will read more into a casual invitation today than the sender meant. Reply to what was actually said.',
 },
 {
 id: 'L060',
 teaser: 'Someone you usually give the benefit of the doubt to will not return the favour today.',
 full: 'A small thing, an interpretation, a tone, an assumption that lands the wrong way. You give them grace by default. The lack of return grace will sting more than the actual incident.',
 action: 'Notice the asymmetry. Don\'t accept it as the permanent shape of the dynamic.',
 timing: 'The signal is strongest in unguarded moments.',
 shareSnippet: 'Someone you give the benefit of the doubt to will not return the favour today. Notice the asymmetry.',
 },
 {
 id: 'L061',
 teaser: 'You will see something today that reminds you of a version of yourself you don\'t miss.',
 full: 'A memory, a photo, a phrase from years ago. The brief flash of the old you will land. You don\'t want them back. That recognition is its own quiet form of progress.',
 action: 'Acknowledge the distance you\'ve travelled instead of getting nostalgic about the wrong things.',
 timing: 'By tonight, this will be clearer.',
 shareSnippet: 'You will see something today that reminds you of a version of yourself you don\'t miss. That is progress.',
 },
 {
 id: 'L062',
 teaser: 'A friend will mention someone today in a way that suggests they know more than they are saying.',
 full: 'It\'ll be in passing, not framed as news. A name dropped at a slightly higher resolution than usual. They are testing whether to tell you the rest. Whether they continue depends on your reaction in the next few seconds.',
 action: 'Stay open. Don\'t shut the conversation down with too quick a response.',
 timing: 'Pay attention to this before the day gets complicated.',
 shareSnippet: 'A friend will mention someone today in a way that suggests they know more than they are saying.',
 },
 {
 id: 'L063',
 teaser: 'You will be asked to be honest today and the honest answer will be inconvenient.',
 full: 'A direct question will land. The truthful response is not the comfortable one for either of you. The instinct will be to soften it past the point of recognition. Soften it a little. Don\'t soften it past the point of being useful.',
 action: 'Say the real thing in the kindest tone you can manage.',
 timing: 'This surfaces by evening.',
 shareSnippet: 'You will be asked to be honest today and the honest answer will be inconvenient. Say it kindly.',
 },
 {
 id: 'L064',
 teaser: 'A moment of physical closeness today will carry more weight than the words around it.',
 full: 'A look that lingers, a touch on the arm, the way someone moves slightly closer or further away. The non-verbal will be the actual conversation. The spoken layer will be the cover.',
 action: 'Trust the body language over the script. The body has fewer reasons to lie.',
 timing: 'Notice this in the first conversation that matters today.',
 shareSnippet: 'A moment of physical closeness today will carry more weight than the words around it. The body has fewer reasons to lie.',
 },
 {
 id: 'L065',
 teaser: 'You will defend someone today to someone else, and the defence will tell you something.',
 full: 'How quickly you reach for the protective explanation, how much energy it takes, what you choose to leave out, all of it is information about where this person actually sits with you.',
 action: 'Listen to your own defence as if it were someone else giving it. Then ask if you believe yourself.',
 timing: 'You will feel this most before you sleep.',
 shareSnippet: 'You will defend someone today, and the defence will tell you something. Listen to your own words.',
 },
 {
 id: 'L066',
 teaser: 'Someone will not text back today and you will overinterpret the silence by tonight.',
 full: 'They are probably fine. Probably busy. Probably forgot. Your brain, given an empty space, will fill it with the worst plausible story. The empty space is not the message. Your fill is.',
 action: 'Cap your interpretation budget at one short story. Don\'t write the trilogy.',
 timing: 'This shows up when you are least distracted.',
 shareSnippet: 'Someone will not text back today and you will overinterpret the silence by tonight. The empty space is not the message.',
 },
 {
 id: 'L067',
 teaser: 'A small kindness from a stranger today will land harder than you expect.',
 full: 'A door held a beat too long, a returned dropped item, a stranger\'s smile that doesn\'t need anything back. It will catch you because the threshold for it has been low. That\'s information about where the rest of the week has put you.',
 action: 'Receive it cleanly. Pass one on within the hour.',
 timing: 'Watch how this plays out after noon.',
 shareSnippet: 'A small kindness from a stranger today will land harder than you expect.',
 },
 {
 id: 'L068',
 teaser: 'You will feel the urge to check on an old conversation today. Most of the urge is curiosity, not love.',
 full: 'The pull will feel meaningful, but most of it is the brain wanting to know how the story ended. That\'s a different question from whether you want them back. Confusing the two creates messes you don\'t need.',
 action: 'Sit with the curiosity for an hour before you act on it. Most of it dissolves.',
 timing: 'The signal is strongest in unguarded moments.',
 shareSnippet: 'You will feel the urge to check on an old conversation today. Most of the urge is curiosity, not love.',
 },
];
