...
export const mood = [
  ...
  },
  {
    ...
    shareSnippet: 'A wave of unexpected calm will arrive today. It tends to arrive when you stop trying for it.',
  },
  {
    id: 'D006',
  ...
  },
  {
    ...
    full: 'There\'s a low-level hum of worry that you may not have fully registered as anxiety. It\'s not acute. But it\'s influencing how you read neutral events, how you respond to people, and what options feel open to you.',
  ...
  },
  {
    ...
    full: 'Something has cleared — a pressure, a preoccupation, a mental weight that has been taking up the space where creative thought lives. The opening is real. It probably won\'t be here tomorrow in the same way.',
  ...
  },
  {
    ...
    action: 'Name the real source of the frustration before you\'re in the situation where it might surface.',
    timing: 'Notice this in the first conversation that matters today.',
  ...
  },
  {
    ...
    full: 'You have a sense about something — a person, a decision, a direction — that your logical mind keeps countermanding. The logical frame may be built on assumptions the intuition is already seeing past. Trust the discomfort it\'s signaling.',
  ...
  },
  {
    ...
    full: 'This isn\'t vanity — it\'s a basic human need running at elevated intensity. The specific form it\'s taking today — recognition, validation, being heard — is worth identifying. What goes unnamed tends to come out sideways.',
  ...
  },
  {
    ...
    full: 'Whatever you\'re dealing with — and it may be real and significant — there is also an absurd element that you haven\'t been allowing yourself to notice. Finding it doesn\'t diminish the seriousness. It creates room to breathe inside it.',
  ...
  {
    id: 'D037',
    teaser: 'The story you\'re telling yourself about why you feel this way may be wrong.',
    full: 'You\'ve assigned a specific cause to your current emotional state. But the state may have a different or more complex origin than the story you\'re running. The assigned cause is usually the most recent visible thing, not the real one.',
    action: 'Ask yourself: is this feeling actually about what I think it\'s about? Sit with the honest answer.',
    timing: 'You will feel this most before you sleep.',
    shareSnippet: 'The story you\'re telling yourself about why you feel this way may be wrong. Ask what it\'s actually about.',
  },
  {
    id: 'D038',
    teaser: 'A small completion available today will free energy that\'s been held in place.',
    full: 'There\'s something unfinished — not large, but persistent — that consumes a small amount of energy every day in the background. It\'s the kind of task that takes 20 minutes and has been waiting three weeks. Finishing it today frees that held energy.',
  ...
  },
  {
    ...
    full: 'There\'s a practice — exercise, time outside, creative work, a specific kind of social contact — that consistently regulates your emotional baseline, and that you\'ve let go without fully registering what it was doing. The absence has a cost.',
  ...
  },
  {
    ...
    full: 'There\'s a period coming — possibly mid-morning, possibly mid-afternoon — where the mental clarity will be higher and the emotional noise lower. The thinking done in that window will be qualitatively better. Reserve the hardest problems for it.',
  ...
  },
  {
    ...
    full: 'You\'ve been managing — responding, adapting, producing, handling. The rate of management has exceeded the rate of restoration. Today\'s highest-value activity might simply be to stop long enough for things to settle rather than adding more management to the pile.',
